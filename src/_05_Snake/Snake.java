...
//        	nextY = head.getLocation ().getY()-1;
        ...
        Location locHead = new Location (nextX, nextY);
        head.setLocation(locHead);
    ...
    private boolean isOppositeDirection(Direction direction) {
    	...
    	if ((direction==Direction.UP && currentDirection == Direction.DOWN) || (direction==Direction.DOWN && currentDirection == Direction.UP)||(direction==Direction.RIGHT && currentDirection == Direction.LEFT)||(direction==Direction.LEFT && currentDirection == Direction.RIGHT)) {
            isOpposite = true;
    	}
